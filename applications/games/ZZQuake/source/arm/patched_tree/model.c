	...
	trivertx_t *pbboxmin, trivertx_t *pbboxmax, aliashdr_t *pheader, char *name)
{
	...
	zzq_alias_stage = 6; pframe = Hunk_AllocName (numv * sizeof(*pframe), loadname);
	...
	trivertx_t *pbboxmin, trivertx_t *pbboxmax, aliashdr_t *pheader, char *name)
{
	...
	zzq_alias_stage = 7; paliasgroup = Hunk_AllocName (sizeof (maliasgroup_t) +
	...
	*pframeindex = (byte *)paliasgroup - (byte *)pheader;
	...
	zzq_alias_stage = 8; poutintervals = Hunk_AllocName (numframes * sizeof (float), loadname);
	...
	aliashdr_t *pheader)
{
	...
	zzq_alias_stage = 3; pskin = Hunk_AllocName (skinsize, loadname);
	pinskin = (byte *)pin;
	...
	aliashdr_t *pheader)
{
	...
	zzq_alias_stage = 4; paliasskingroup = Hunk_AllocName (sizeof (maliasskingroup_t) +
	...
	*pskinindex = (byte *)paliasskingroup - (byte *)pheader;
	...
	zzq_alias_stage = 5; poutskinintervals = Hunk_AllocName (numskins * sizeof (float),loadname);
...
//
	...
	zzq_alias_stage = 1; pheader = Hunk_AllocName (size, loadname);
...
//
	...
	zzq_alias_stage = 2; pskindesc = Hunk_AllocName (numskins * sizeof (maliasskindesc_t),
								loadname);
