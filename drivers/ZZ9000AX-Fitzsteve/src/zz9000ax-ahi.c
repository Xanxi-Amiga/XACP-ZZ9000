 ...
 *
 * Fitzsteve Edition FS1 (19.09.2026)
 * Two AHI mixing channels for XACP game ports using SFX with MP3 or ZZMIDI music.
 *
...
#define DEVICE_DATE "(19.09.2026)"
#define DEVICE_VERSION 4
#define DEVICE_REVISION 19
#define DEVICE_ID_STRING "ZZ9000AX " XSTR(DEVICE_VERSION) "." XSTR(DEVICE_REVISION) "-FS1 " DEVICE_DATE
...
/* Two AHI mixing channels for XACP game ports (SFX + MP3/ZZMIDI). */
#define FITZSTEVE_MAX_CHANNELS 2
