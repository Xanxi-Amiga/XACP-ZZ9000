...
#include "xacp_memory_map_v1_7.h"
    ...
    switch (zdata) {
        ...
        case ACC_OP_DECOMPRESS:
            ...
            switch(data->u8_user[0]) {
                /* XACP v1.7: legacy SMUSH codecs are no longer built.
                 * ABI values remain reserved; requests are ignored. */
        ...
        case ACC_OP_CODEC_OP:
            /* XACP v1.7: legacy SMUSH codec operations are ignored. */
            break;
        default:
            break;
    }
